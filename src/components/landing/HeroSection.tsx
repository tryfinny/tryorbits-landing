...
export function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <MorphingBlob
        className="top-10 left-[5%] w-[300px] sm:w-[500px] h-[300px] sm:h-[500px] orb-lavender opacity-30 sm:opacity-40"
        delay={0}
      />
      <MorphingBlob
        className="top-40 right-[10%] w-[250px] sm:w-[400px] h-[250px] sm:h-[400px] orb-peach opacity-25 sm:opacity-30"
        delay={5}
      />
      <MorphingBlob
        className="bottom-20 left-[20%] w-[350px] sm:w-[600px] h-[350px] sm:h-[600px] orb-sky opacity-20 sm:opacity-25"
        delay={10}
      />
      ...
      >
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-20 items-center">
          ...
          >
            ...
            <motion.div
              variants={fadeUpSpring}
              className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 justify-center lg:justify-start mb-8"
            >
