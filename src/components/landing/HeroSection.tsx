      ...
      scale
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-20 items-center">
          ...
          <motion.div variants={staggerContainer} initial="hidden" animate="visible" className="text-center lg:text-left">
            ...
            {/* Subheadline */}
            <motion.p variants={fadeUpSpring} className="text-base sm:text-lg lg:text-xl text-muted-foreground mb-8 sm:mb-10 max-w-lg mx-auto lg:mx-0 leading-relaxed">Welcome to Orbits, the assistant for home.
Whether its managing your grocery list, juggling your family calendars, or finding a new babysitter, Orbits can take care of it for you all by itself (and more!)</motion.p>
